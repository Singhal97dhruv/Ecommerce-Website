...
export const getAllReviews=(id)=>async (dispatch)=>{
    ...
    //    console.log(`/api/v1/reviews?id=${id} `);
        const {data}=await axios.get(`/api/v1/reviews`,{params:{id: `${id}`}})
...
export const deleteReviews=(reviewId,productId)=>async (dispatch)=>{
    try{
        ...
        const {data}=await axios.delete(`/api/v1/reviews`,{params:{id: `${reviewId}`,productId: `${productId}`}})
        dispatch({
